-- ============================================================
-- Agent Registration: Construction Law Research Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Construction Law Research Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Legal Precedents & Regulatory Updates Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Construction Law Research Agent'
...
-- FROM agents WHERE name = 'Construction Law Research Agent';
