-- ============================================================
-- Agent Registration: mobile-patterns-agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the mobile-patterns-agent agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'mobile-patterns-agent'
...
-- FROM agents WHERE name = 'mobile-patterns-agent';
