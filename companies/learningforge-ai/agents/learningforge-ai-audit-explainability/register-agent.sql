-- ============================================================
-- Agent Registration: Audit & Explainability Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Audit & Explainability Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Activity Logging & Explainability Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Audit & Explainability Agent'
...
-- FROM agents WHERE name = 'Audit & Explainability Agent';
