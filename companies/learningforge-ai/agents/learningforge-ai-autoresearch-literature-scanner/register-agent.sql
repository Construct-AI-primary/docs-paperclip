-- ============================================================
-- Agent Registration: AutoResearch Literature Scanner
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the AutoResearch Literature Scanner agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Academic & Technical Literature Scanner',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'AutoResearch Literature Scanner'
...
-- FROM agents WHERE name = 'AutoResearch Literature Scanner';
