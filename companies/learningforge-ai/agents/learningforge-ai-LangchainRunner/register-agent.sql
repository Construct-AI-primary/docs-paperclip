-- ============================================================
-- Agent Registration: LangChain Runner Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the LangChain Runner Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Deep Agents Orchestration Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'LangChain Runner Agent'
...
-- FROM agents WHERE name = 'LangChain Runner Agent';
