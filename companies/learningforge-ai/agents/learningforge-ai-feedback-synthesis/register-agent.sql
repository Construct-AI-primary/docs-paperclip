-- ============================================================
-- Agent Registration: Feedback Synthesis Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Feedback Synthesis Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Feedback Aggregation Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Feedback Synthesis Agent'
...
-- FROM agents WHERE name = 'Feedback Synthesis Agent';
