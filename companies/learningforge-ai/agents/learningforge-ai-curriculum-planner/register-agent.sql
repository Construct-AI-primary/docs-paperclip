-- ============================================================
-- Agent Registration: Curriculum Planner
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Curriculum Planner agent
-- ============================================================
...
SELECT
  ...
  'Curriculum Planner',
  'specialist',
  'Learning Path Sequencing Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Curriculum Planner'
...
-- FROM agents WHERE name = 'Curriculum Planner';
