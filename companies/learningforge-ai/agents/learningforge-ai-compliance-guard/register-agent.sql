-- ============================================================
-- Agent Registration: Compliance Guard Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Compliance Guard Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Safety-Aware Compliance Validation',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Compliance Guard Agent'
...
-- FROM agents WHERE name = 'Compliance Guard Agent';
