-- ============================================================
-- Agent Registration: Research Scheduler Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Research Scheduler Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Research Cycle Orchestration Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Research Scheduler Agent'
...
-- FROM agents WHERE name = 'Research Scheduler Agent';
