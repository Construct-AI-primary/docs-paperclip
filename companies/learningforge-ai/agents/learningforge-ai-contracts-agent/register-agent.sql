-- ============================================================
-- Agent Registration: Contracts Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Contracts Agent agent
-- ============================================================
...
SELECT
  ...
  'Contracts Agent',
  'specialist',
  'Construction Contracts Learning Specialist',
  '🤖',
  'idle',
...
-- FROM agents WHERE name = 'Contracts Agent';
