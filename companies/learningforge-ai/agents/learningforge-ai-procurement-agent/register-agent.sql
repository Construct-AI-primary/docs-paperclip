-- ============================================================
-- Agent Registration: Procurement Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Procurement Agent agent
-- ============================================================
...
SELECT
  ...
  'Procurement Agent',
  'specialist',
  'Procurement & Supply Chain Learning Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Procurement Agent'
...
-- FROM agents WHERE name = 'Procurement Agent';
