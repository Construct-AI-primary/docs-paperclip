-- ============================================================
-- Agent Registration: learning-integration-agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the learning-integration-agent agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'learning-integration-agent'
...
-- FROM agents WHERE name = 'learning-integration-agent';
