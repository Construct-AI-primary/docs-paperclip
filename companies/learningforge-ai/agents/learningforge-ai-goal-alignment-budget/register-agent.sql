-- ============================================================
-- Agent Registration: Goal Alignment & Budget Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Goal Alignment & Budget Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Strategic Alignment & Resource Governance',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Goal Alignment & Budget Agent'
...
-- FROM agents WHERE name = 'Goal Alignment & Budget Agent';
