-- ============================================================
-- Agent Registration: Priority Disciplines Lead
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Priority Disciplines Lead agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Priority Disciplines Lead'
...
-- FROM agents WHERE name = 'Priority Disciplines Lead';
