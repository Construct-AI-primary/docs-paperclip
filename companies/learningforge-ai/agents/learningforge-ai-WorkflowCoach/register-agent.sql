-- ============================================================
-- Agent Registration: Workflow Coach
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Workflow Coach agent
-- ============================================================
...
SELECT
  ...
  'Workflow Coach',
  'specialist',
  'Workflow Enforcement Specialist',
  '🤖',
  'idle',
...
-- FROM agents WHERE name = 'Workflow Coach';
