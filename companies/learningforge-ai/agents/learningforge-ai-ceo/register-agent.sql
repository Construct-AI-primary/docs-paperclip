-- ============================================================
-- Agent Registration: Learning Strategy Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Learning Strategy Agent agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Learning Strategy Agent'
...
-- FROM agents WHERE name = 'Learning Strategy Agent';
