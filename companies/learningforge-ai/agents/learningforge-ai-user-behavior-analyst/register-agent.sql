-- ============================================================
-- Agent Registration: User Behavior Analyst
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the User Behavior Analyst agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Learning Gap Detection Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'User Behavior Analyst'
...
-- FROM agents WHERE name = 'User Behavior Analyst';
