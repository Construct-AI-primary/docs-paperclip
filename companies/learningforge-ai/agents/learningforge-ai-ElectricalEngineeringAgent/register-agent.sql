-- ============================================================
-- Agent Registration: Electrical Engineering Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Electrical Engineering Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Electrical Engineering Learning Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Electrical Engineering Agent'
...
-- FROM agents WHERE name = 'Electrical Engineering Agent';
