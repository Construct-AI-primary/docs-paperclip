-- ============================================================
-- Agent Registration: Safety Quality Division Lead
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Safety Quality Division Lead agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Safety Quality Division Lead'
...
-- FROM agents WHERE name = 'Safety Quality Division Lead';
