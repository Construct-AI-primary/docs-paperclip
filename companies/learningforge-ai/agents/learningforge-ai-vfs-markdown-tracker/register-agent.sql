-- ============================================================
-- Agent Registration: VFS Markdown Tracker
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the VFS Markdown Tracker agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'File Operation Logging Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'VFS Markdown Tracker'
...
-- FROM agents WHERE name = 'VFS Markdown Tracker';
