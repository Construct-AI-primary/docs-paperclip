-- ============================================================
-- Agent Registration: Equipment Innovation Research Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Equipment Innovation Research Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Materials & Equipment Breakthroughs Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Equipment Innovation Research Agent'
...
-- FROM agents WHERE name = 'Equipment Innovation Research Agent';
