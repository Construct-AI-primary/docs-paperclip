-- ============================================================
-- Agent Registration: Defect Pattern Research Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Defect Pattern Research Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Defect Analysis & Pattern Recognition Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Defect Pattern Research Agent'
...
-- FROM agents WHERE name = 'Defect Pattern Research Agent';
