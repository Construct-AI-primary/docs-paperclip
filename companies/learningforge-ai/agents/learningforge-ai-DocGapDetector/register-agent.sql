-- ============================================================
-- Agent Registration: Doc Gap Detector
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Doc Gap Detector agent
-- ============================================================
...
-- FROM agents WHERE name = 'Doc Gap Detector';
