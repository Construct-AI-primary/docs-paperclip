-- ============================================================
-- Agent Registration: VFS Watcher Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the VFS Watcher Agent agent
-- ============================================================
...
SELECT
  ...
  'VFS Watcher Agent',
  'specialist',
  'Virtual File System Change Monitor',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'VFS Watcher Agent'
...
-- FROM agents WHERE name = 'VFS Watcher Agent';
