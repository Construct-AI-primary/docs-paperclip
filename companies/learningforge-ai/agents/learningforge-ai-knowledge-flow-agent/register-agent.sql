-- ============================================================
-- Agent Registration: Knowledge Flow Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Knowledge Flow Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Knowledge Graph & Flow Mapping Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Knowledge Flow Agent'
...
-- FROM agents WHERE name = 'Knowledge Flow Agent';
