-- ============================================================
-- Agent Registration: Micro-Lesson Generator
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Micro-Lesson Generator agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Scenario-Based Exercise Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Micro-Lesson Generator'
...
-- FROM agents WHERE name = 'Micro-Lesson Generator';
