-- ============================================================
-- Agent Registration: Knowledge Hygiene Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Knowledge Hygiene Agent agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Knowledge Hygiene Agent'
...
-- FROM agents WHERE name = 'Knowledge Hygiene Agent';
