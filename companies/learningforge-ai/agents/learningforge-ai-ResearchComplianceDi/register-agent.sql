-- ============================================================
-- Agent Registration: Research Compliance Division Lead
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Research Compliance Division Lead agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Research Compliance Division Lead'
...
-- FROM agents WHERE name = 'Research Compliance Division Lead';
