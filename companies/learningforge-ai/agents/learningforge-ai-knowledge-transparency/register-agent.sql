-- ============================================================
-- Agent Registration: Knowledge Transparency Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Knowledge Transparency Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Knowledge Trail Display Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Knowledge Transparency Agent'
...
-- FROM agents WHERE name = 'Knowledge Transparency Agent';
