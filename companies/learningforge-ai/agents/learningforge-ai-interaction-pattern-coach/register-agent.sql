-- ============================================================
-- Agent Registration: Interaction Pattern Coach
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Interaction Pattern Coach agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Personalized Learning Nudges Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Interaction Pattern Coach'
...
-- FROM agents WHERE name = 'Interaction Pattern Coach';
