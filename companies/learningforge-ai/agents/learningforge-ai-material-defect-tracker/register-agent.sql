-- ============================================================
-- Agent Registration: Material Defect Tracker
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Material Defect Tracker agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Material Defect Tracker'
...
-- FROM agents WHERE name = 'Material Defect Tracker';
