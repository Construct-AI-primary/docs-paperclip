-- ============================================================
-- Agent Registration: Knowledge Provenance Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Knowledge Provenance Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Trace Graph Building Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Knowledge Provenance Agent'
...
-- FROM agents WHERE name = 'Knowledge Provenance Agent';
