-- ============================================================
-- Agent Registration: From Doc To Lesson Generator
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the From Doc To Lesson Generator agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Content Transformation Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'From Doc To Lesson Generator'
...
-- FROM agents WHERE name = 'From Doc To Lesson Generator';
