-- ============================================================
-- Agent Registration: Doc Usage Analyzer
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Doc Usage Analyzer agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Doc Usage Analyzer'
...
-- FROM agents WHERE name = 'Doc Usage Analyzer';
