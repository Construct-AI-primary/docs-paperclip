-- ============================================================
-- Agent Registration: Logistics Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Logistics Agent agent
-- ============================================================
...
SELECT
  ...
  'Logistics Agent',
  'specialist',
  'Logistics & Operations Learning Specialist',
  '🤖',
  'idle',
...
-- FROM agents WHERE name = 'Logistics Agent';
