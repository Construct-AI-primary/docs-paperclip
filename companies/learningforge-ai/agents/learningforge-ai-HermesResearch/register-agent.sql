-- ============================================================
-- Agent Registration: Hermes Research Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Hermes Research Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'General Autonomous Research Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Hermes Research Agent'
...
-- FROM agents WHERE name = 'Hermes Research Agent';
