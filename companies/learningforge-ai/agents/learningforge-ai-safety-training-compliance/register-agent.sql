-- ============================================================
-- Agent Registration: Safety Training Compliance Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Safety Training Compliance Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Certification Tracking Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Safety Training Compliance Agent'
...
-- FROM agents WHERE name = 'Safety Training Compliance Agent';
