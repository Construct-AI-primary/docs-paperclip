-- ============================================================
-- Agent Registration: Assessment Mastery Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Assessment Mastery Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Adaptive Assessment Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Assessment Mastery Agent'
...
-- FROM agents WHERE name = 'Assessment Mastery Agent';
