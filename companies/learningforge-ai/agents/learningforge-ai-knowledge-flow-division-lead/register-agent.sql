-- ============================================================
-- Agent Registration: Knowledge Flow Division Lead
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Knowledge Flow Division Lead agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Knowledge Flow Division Lead'
...
-- FROM agents WHERE name = 'Knowledge Flow Division Lead';
