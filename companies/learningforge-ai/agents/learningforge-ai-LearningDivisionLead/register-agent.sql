-- ============================================================
-- Agent Registration: Learning Division Lead
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Learning Division Lead agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Learning Division Lead'
...
-- FROM agents WHERE name = 'Learning Division Lead';
