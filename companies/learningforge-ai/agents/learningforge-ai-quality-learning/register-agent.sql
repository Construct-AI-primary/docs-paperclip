-- ============================================================
-- Agent Registration: Quality Learning Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Quality Learning Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Defect-Based Learning Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Quality Learning Agent'
...
-- FROM agents WHERE name = 'Quality Learning Agent';
