-- ============================================================
-- Agent Registration: Field Safety Inspector
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Field Safety Inspector agent
-- ============================================================
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Field Safety Inspector'
...
-- FROM agents WHERE name = 'Field Safety Inspector';
