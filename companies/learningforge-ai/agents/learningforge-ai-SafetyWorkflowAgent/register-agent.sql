-- ============================================================
-- Agent Registration: Safety Workflow Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Safety Workflow Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Safety Management Learning Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Safety Workflow Agent'
...
-- FROM agents WHERE name = 'Safety Workflow Agent';
