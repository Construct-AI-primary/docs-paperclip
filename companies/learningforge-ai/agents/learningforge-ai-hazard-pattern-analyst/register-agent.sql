-- ============================================================
-- Agent Registration: Hazard Pattern Analyst
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Hazard Pattern Analyst agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Safety Pattern Recognition Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Hazard Pattern Analyst'
...
-- FROM agents WHERE name = 'Hazard Pattern Analyst';
