-- ============================================================
-- Agent Registration: Safety Regulation Research Agent
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the Safety Regulation Research Agent agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Safety Standards & Best Practices Researcher',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'Safety Regulation Research Agent'
...
-- FROM agents WHERE name = 'Safety Regulation Research Agent';
