-- ============================================================
-- Agent Registration: AutoResearch Skills Enhancer
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the AutoResearch Skills Enhancer agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Skills Auto-Improvement Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'AutoResearch Skills Enhancer'
...
-- FROM agents WHERE name = 'AutoResearch Skills Enhancer';
