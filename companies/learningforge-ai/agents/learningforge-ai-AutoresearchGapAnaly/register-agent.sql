-- ============================================================
-- Agent Registration: AutoResearch Gap Analyzer
-- Company: LearningForge AI
-- Date: 2026-04-21
-- Purpose: Register the AutoResearch Gap Analyzer agent
-- ============================================================
...
SELECT
  ...
  'specialist',
  'Knowledge & Skill Gap Analysis Specialist',
  '🤖',
  'idle',
...
WHERE c.name = 'LearningForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'AutoResearch Gap Analyzer'
...
-- FROM agents WHERE name = 'AutoResearch Gap Analyzer';
