...
- **Interface Management Knowledge** (`docs-paperclip/disciplines-non/00170-modal-management/knowledge/PAGE-KNOWLEDGE.md`): Comprehensive knowledge of UI components, modal dialogs, and interface management systems
  - Modal dialog management and lifecycle
  - Chatbot interface management and conversation flows
...
- **Chatbot Management Documentation** (`docs-construct-ai/disciplines-non/00170-chatbot-management/`)
- **Agent Simulation UI Documentation** (`docs-construct-ai/disciplines-non/02050-agent-simulation-ui/`)

## Skills

- **interfacespecialist-knowledgeforge**: Core interface management capabilities
- **interfacespecialist-knowledgeforge-ui**: UI component and design skills
- **interfacespecialist-knowledgeforge-modal**: Modal and dialog management skills
