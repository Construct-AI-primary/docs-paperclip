-- ============================================================
-- Agent Registration: technical-seo-specialist
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the technical-seo-specialist agent
-- ============================================================
...
SELECT
  ...
  'Technical SEO Implementation Expert',
  'Technical SEO Implementation Expert',
  '🤖',
  'idle',
  NULL,
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'technical-seo-specialist'
...
-- FROM agents WHERE name = 'technical-seo-specialist';
