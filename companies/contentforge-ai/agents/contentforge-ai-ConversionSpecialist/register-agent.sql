-- ============================================================
-- Agent Registration: conversion-specialist
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the conversion-specialist agent
-- ============================================================
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'conversion-specialist'
...
-- FROM agents WHERE name = 'conversion-specialist';
