-- ============================================================
-- Agent Registration: link-builder
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the link-builder agent
-- ============================================================
...
SELECT
  ...
  c.id,
  'link-builder',
  'Link Building & Authority Specialist',
  'Link Building & Authority Specialist',
  '🤖',
  'idle',
  NULL,
...
-- FROM agents WHERE name = 'link-builder';
