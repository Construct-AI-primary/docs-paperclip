-- ============================================================
-- Agent Registration: reporting-specialist
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the reporting-specialist agent
-- ============================================================
...
SELECT
  ...
  'Analytics Reporting & Dashboard Expert',
  'Analytics Reporting & Dashboard Expert',
  '🤖',
  'idle',
  NULL,
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'reporting-specialist'
...
-- FROM agents WHERE name = 'reporting-specialist';
