-- ============================================================
-- Agent Registration: performance-optimizer
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the performance-optimizer agent
-- ============================================================
...
SELECT
  ...
  'Website Performance Team Lead & Core Web Vitals Specialist',
  'Website Performance Team Lead & Core Web Vitals Specialist',
  '🤖',
  'idle',
  NULL,
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'performance-optimizer'
...
-- FROM agents WHERE name = 'performance-optimizer';
