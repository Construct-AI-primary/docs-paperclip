-- ============================================================
-- Agent Registration: mobile-optimizer
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the mobile-optimizer agent
-- ============================================================
...
SELECT
  ...
  c.id,
  'mobile-optimizer',
  'Mobile Performance & Design Specialist',
  'Mobile Performance & Design Specialist',
  '🤖',
  'idle',
  NULL,
...
-- FROM agents WHERE name = 'mobile-optimizer';
