-- ============================================================
-- Agent Registration: communication-orchestrator
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the communication-orchestrator agent
-- ============================================================
...
SELECT
  ...
  '🤖',
  'idle',
  'contentforge-ai-operations-director',
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'communication-orchestrator'
...
-- FROM agents WHERE name = 'communication-orchestrator';
