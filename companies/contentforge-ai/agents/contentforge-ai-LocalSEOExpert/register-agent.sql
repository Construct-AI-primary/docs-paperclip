-- ============================================================
-- Agent Registration: local-seo-expert
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the local-seo-expert agent
-- ============================================================
...
SELECT
  ...
  c.id,
  'local-seo-expert',
  'Local Search Optimization Specialist',
  'Local Search Optimization Specialist',
  '🤖',
  'idle',
  NULL,
...
-- FROM agents WHERE name = 'local-seo-expert';
