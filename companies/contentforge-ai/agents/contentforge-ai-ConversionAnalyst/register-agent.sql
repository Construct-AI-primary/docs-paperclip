-- ============================================================
-- Agent Registration: conversion-analyst
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the conversion-analyst agent
-- ============================================================
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'conversion-analyst'
...
-- FROM agents WHERE name = 'conversion-analyst';
