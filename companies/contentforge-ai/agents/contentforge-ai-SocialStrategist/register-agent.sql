-- ============================================================
-- Agent Registration: social-strategist
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the social-strategist agent
-- ============================================================
...
WHERE c.name = 'ContentForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'social-strategist'
...
-- FROM agents WHERE name = 'social-strategist';
