-- ============================================================
-- Agent Registration: seo-strategist
-- Company: ContentForge AI
-- Date: 2026-04-21
-- Purpose: Register the seo-strategist agent
-- ============================================================
...
SELECT
  ...
  c.id,
  'seo-strategist',
  'SEO Optimization Team Lead & Strategy Specialist',
  'SEO Optimization Team Lead & Strategy Specialist',
  '🤖',
  'idle',
  NULL,
...
-- FROM agents WHERE name = 'seo-strategist';
