-- ============================================================
-- Agent Registration: database-infraforge-database-infrastructure
-- Company: InfraForge AI
-- Date: 2026-04-21
-- Purpose: Register the database-infraforge-database-infrastructure agent
-- ============================================================
...
WHERE c.name = 'InfraForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'database-infraforge-database-infrastructure'
...
-- FROM agents WHERE name = 'database-infraforge-database-infrastructure';
