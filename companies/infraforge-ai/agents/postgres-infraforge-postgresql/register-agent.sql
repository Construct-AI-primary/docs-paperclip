-- ============================================================
-- Agent Registration: postgres-infraforge
-- Company: InfraForge AI
-- Date: 2026-04-21
-- Purpose: Register the postgres-infraforge agent
-- ============================================================
...
WHERE c.name = 'InfraForge AI'
  AND NOT EXISTS (
    ...
    WHERE a.name = 'postgres-infraforge'
...
-- FROM agents WHERE name = 'postgres-infraforge';
