...
gigabrain_tags: agents, domain-forge, ethics
documentation
...
**Agent ID:** `ethics-domainforge-ethics`  
...
Specializes in understanding and documenting the **code structures, page implementations, and technical architecture** for ethics discipline within the Paperclip ecosystem.

### Core Responsibilities

1. **Code Structure Analysis**
   - Analyze ethics codebase structure
...
3. **Quality Standards**
   - Ensure compliance with ethics standards
...
4. **Cross-Discipline Integration**
   ...
   - Ensure ethics systems integrate with broader infrastructure
...
- **Documentation Coverage**: 100% of ethics code documented
...
- **Construct-AI**: Ethics discipline coordination
