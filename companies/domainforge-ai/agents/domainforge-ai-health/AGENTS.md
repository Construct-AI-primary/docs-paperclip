...
gigabrain_tags: agents, domain-forge, health
documentation
...
**Agent ID:** `health-domainforge-health`  
...
Specializes in understanding and documenting the **code structures, page implementations, and technical architecture** for health discipline within the Paperclip ecosystem.

### Core Responsibilities

1. **Code Structure Analysis**
   - Analyze health codebase structure
...
4. **Cross-Discipline Integration**
   ...
   - Ensure health systems integrate with broader infrastructure
...
- **Documentation Coverage**: 100% of health code documented
...
- **Construct-AI**: Health discipline coordination
