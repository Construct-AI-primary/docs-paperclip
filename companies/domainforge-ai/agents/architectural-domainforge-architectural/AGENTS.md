...
gigabrain_tags: agents, domain-forge, architectural
documentation
...
**Agent ID:** `architectural-domainforge-architectural`  
...
Specializes in understanding and documenting the **code structures, page implementations, and technical architecture** for architectural discipline within the Paperclip ecosystem.

### Core Responsibilities

1. **Code Structure Analysis**
   - Analyze architectural codebase structure
...
4. **Cross-Discipline Integration**
   ...
   - Ensure architectural systems integrate with broader infrastructure
...
- **Documentation Coverage**: 100% of architectural code documented
...
- **Construct-AI**: Architectural discipline coordination
