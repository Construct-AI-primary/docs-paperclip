...
gigabrain_tags: agents, domain-forge, process-engineering
documentation
...
**Agent ID:** `process-engineering-domainforge-process-engineering`  
...
Specializes in understanding and documenting the **code structures, page implementations, and technical architecture** for process engineering discipline within the Paperclip ecosystem.

### Core Responsibilities

1. **Code Structure Analysis**
   - Analyze process engineering codebase structure
...
3. **Quality Standards**
   - Ensure compliance with process engineering standards
...
4. **Cross-Discipline Integration**
   ...
   - Ensure process engineering systems integrate with broader infrastructure
...
- **Documentation Coverage**: 100% of process engineering code documented
...
- **Construct-AI**: Process Engineering discipline coordination
