...
gigabrain_tags: agents, domain-forge, sales-director
documentation
...
**Agent ID:** `sales-director-domainforge-sales-director`  
...
Specializes in understanding and documenting the **code structures, page implementations, and technical architecture** for sales director discipline within the Paperclip ecosystem.

### Core Responsibilities

1. **Code Structure Analysis**
   - Analyze sales director codebase structure
...
3. **Quality Standards**
   - Ensure compliance with sales director standards
...
4. **Cross-Discipline Integration**
   ...
   - Ensure sales director systems integrate with broader infrastructure
...
- **Documentation Coverage**: 100% of sales director code documented
...
- **Construct-AI**: Sales Director discipline coordination
