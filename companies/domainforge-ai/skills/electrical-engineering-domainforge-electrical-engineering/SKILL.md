...
gigabrain_tags: skills, domain-forge, electrical-engineering-domainforge-electrical-engineering
documentation
...
# electrical engineering DomainForge electrical engineering Skill

**Skill ID:** `electrical-engineering-domainforge-electrical-engineering`  
**Agent:** `electrical-engineering-domainforge-electrical-engineering`  
...
- Sector: `disciplines-sector-specific-details/{sector_ref}/knowledge/electrical-*-knowledge.md`
