...
gigabrain_tags: skills, domain-forge, project-controls-domainforge-project-controls
documentation
...
# project controls DomainForge project controls Skill

**Skill ID:** `project-controls-domainforge-project-controls`  
**Agent:** `project-controls-domainforge-project-controls`  
