...
gigabrain_tags: skills, domain-forge, contracts-pre-award-domainforge-contracts-pre-award
documentation
...
# contracts pre award DomainForge contracts pre award Skill

**Skill ID:** `contracts-pre-award-domainforge-contracts-pre-award`  
**Agent:** `contracts-pre-award-domainforge-contracts-pre-award`  
