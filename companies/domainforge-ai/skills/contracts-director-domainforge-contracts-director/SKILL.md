...
gigabrain_tags: skills, domain-forge, contracts-director-domainforge-contracts-director
documentation
...
# contracts director DomainForge contracts director Skill

**Skill ID:** `contracts-director-domainforge-contracts-director`  
**Agent:** `contracts-director-domainforge-contracts-director`  
