...
gigabrain_tags: skills, domain-forge, document-control-domainforge-document-control
documentation
...
# document control DomainForge document control Skill

**Skill ID:** `document-control-domainforge-document-control`  
**Agent:** `document-control-domainforge-document-control`  
