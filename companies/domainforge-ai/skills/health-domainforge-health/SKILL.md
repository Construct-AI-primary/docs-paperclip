...
gigabrain_tags: skills, domain-forge, health-domainforge-health
documentation
...
# health DomainForge health Skill

**Skill ID:** `health-domainforge-health`  
**Agent:** `health-domainforge-health`  
