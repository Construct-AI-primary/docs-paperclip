---
id: QS-001
title: 02025 Page Foundation — Login, Navigation & Logout
...
- [ ] CSS class naming follows `A-02025-*` convention
...
**Critical** — blocks all subsequent testing. A failure in any foundation component halts the entire QS-TEST pipeline.
...
- [ ] **CSS class naming:** All page-level elements use `A-02025-*` class prefix convention
