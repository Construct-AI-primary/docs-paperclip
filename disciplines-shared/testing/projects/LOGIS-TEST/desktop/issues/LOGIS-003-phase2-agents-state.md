---
id: LOGIS-003
title: 01700 Agents State — Freight Booking & Customs Clearance
...
labels: ["testing", "logistics", "2 — State Buttons & Modals"]
blocked_by: []
...
# LOGIS-003: 01700 Agents State — Freight Booking & Customs Clearance

## Executive Summary

This issue validates the Agents state of the 01700 logistics page. Two modal triggers (Freight Booking, Customs Clearance) must render correctly, open their respective modals, validate form inputs, persist data to the correct Supabase tables, and close cleanly.

## Problem Statement / Scope

The Agents state contains 2 modal buttons: Freight Booking (01700-FreightBookingModal) and Customs Clearance (01700-CustomsClearanceModal). Each modal must display logistics-specific forms, validate required fields, submit data to `logistics_freight` or `logistics_customs` tables respectively, handle errors gracefully, and close properly.
...
| 3D | Freight Booking submission | Data persists to logistics_freight table |
...
| 3G | Customs Clearance submission | Data persists to logistics_customs table |

## Acceptance Criteria

- [ ] Agents state button triggers state change to 'agents'
- [ ] Freight Booking modal trigger renders with correct id
- [ ] 01700-FreightBookingModal opens on click
...
- [ ] **Freight Booking:** Form fields match logistics_freight schema columns
- [ ] **Freight Booking:** Origin/destination required validation works
- [ ] **Freight Booking:** Weight must be positive number
- [ ] **Freight Booking:** Submission writes to logistics_freight table
- [ ] **Customs Clearance:** Form fields match logistics_customs schema
- [ ] **Customs Clearance:** Document upload validates file types
- [ ] **Customs Clearance:** Submission writes to logistics_customs table
