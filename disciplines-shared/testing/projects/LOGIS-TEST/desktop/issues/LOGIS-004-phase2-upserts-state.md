---
id: LOGIS-004
title: 01700 Upserts State — Cloud, URL & File Upserts
...
# LOGIS-004: 01700 Upserts State — Cloud, URL & File Upserts

## Executive Summary

This issue validates the Upserts state of the 01700 logistics page. Three modal triggers (Cloud Upsert, URL Upsert, File Upsert) must render correctly, open their respective modals, process data, and persist to the vectors table. Database persistence checks are delegated to database-infraforge.

## Problem Statement / Scope

The Upserts state contains 3 modal buttons: Cloud Upsert (01700-UpsertCloudModal), URL Upsert (01700-UpsertUrlModal), and File Upsert (01700-UpsertFileModal). Each modal provides different data ingestion mechanisms for the vectors table.
