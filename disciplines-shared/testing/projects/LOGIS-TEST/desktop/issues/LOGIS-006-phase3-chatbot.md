---
id: LOGIS-006
title: 01700 Chatbot — HITL & Confidence Thresholds
description: Verify LogisticsChatbot renders with logistics blue theme, HITL confidence threshold of 0.7, citations, and history persistence
...
goals:
  ...
  agent_goal: "As validator-qualityforge, verify LogisticsChatbot renders with logistics blue theme (#0D47A1/#1565C0), HITL confidence threshold of 0.7, citations, and history persistence"
  task_goal: "Execute chatbot validation with >90% pass rate"
---

# LOGIS-006: 01700 Chatbot — HITL & Confidence Thresholds

## Executive Summary

This issue validates the LogisticsChatbot component on the 01700 logistics page. The chatbot must render with the logistics blue theme (#0D47A1/#1565C0), trigger human-in-the-loop at confidence < 0.7, provide citations with sources, show document counts, and persist conversation history per session.

## Problem Statement / Scope

The LogisticsChatbot is the primary AI assistant for the logistics page. It must handle logistics-specific queries about freight booking, customs clearance, fleet management, and supply chain operations. When confidence falls below 0.7, HITL must be triggered to ensure accurate responses.

## Required Actions

| Step | Action | Expected Result |
|------|--------|-----------------|
| 6A | Chatbot render | Chatbot renders with logistics blue theme (#0D47A1/#1565C0) |
...
- [ ] Chatbot renders with logistics blue color scheme (#0D47A1 header, #1565C0 accents)
...
- [ ] **Logistics context:** Chatbot responds to logistics-specific queries
