---
id: LOGIS-005
title: 01700 Workspace State — Fleet, Warehouse, Supplier Directory, Cross-Discipline, Vector Manager
...
# LOGIS-005: 01700 Workspace State — Fleet, Warehouse, Supplier Directory, Cross-Discipline, Vector Manager

## Executive Summary

This issue validates the Workspace state of the 01700 logistics page. Five modal triggers (Fleet Management, Warehouse Management, Supplier Directory, Cross-Discipline Sharing, Vector Data Manager) must render correctly, open their respective modals, and perform their intended operations.

## Problem Statement / Scope

The Workspace state contains 5 modal buttons covering logistics operations: Fleet Management (01700-FleetManagementModal), Warehouse Management (01700-WarehouseManagementModal), Supplier Directory (01700-SupplierDirectoryModal), Cross-Discipline Sharing (DisciplinePermissionMatrixModal), and Vector Data Manager (VectorDataManagerModal).
...
- [ ] 01700-FleetManagementModal opens with vehicle list
- [ ] Fleet vehicle CRUD operations persist to logistics_fleet
...
- [ ] 01700-WarehouseManagementModal opens with inventory
- [ ] Stock level updates persist
- [ ] Supplier Directory button renders in Workspace state
- [ ] 01700-SupplierDirectoryModal opens with supplier list
...
- [ ] **Fleet Management:** CRUD on logistics_fleet table verified
