---
title: Cross-Company RACI Matrix — LOGIS-TEST
...
# Cross-Company RACI Matrix — LOGIS-TEST
...
|-------|------------------------|-------------|-------------|----------------|------------|
| LOGIS-001 | validator-qualityforge (QF) | QF | I | C | I |
| LOGIS-002 | database-infraforge (IF) | IF | I | C | A |
| LOGIS-003 | validator-qualityforge (QF) | QF | I | I | I |
| LOGIS-004 | validator-qualityforge (QF) | QF | I | I | C |
| LOGIS-005 | validator-qualityforge (QF) | QF | I | I | I |
| LOGIS-006 | validator-qualityforge (QF) | QF | I | C | I |
| LOGIS-007 | logistics-domainforge-logistics (DF) | DF | A | I | I |
| LOGIS-008 | logistics-domainforge-logistics (DF) | DF | A | C | I |
| LOGIS-009 | logistics-domainforge-fleet (DF) | DF | A | I | I |
| LOGIS-010 | logistics-domainforge-customs (DF) | DF | A | I | I |
| LOGIS-011 | validator-qualityforge (QF) | QF | C | I | C |
| LOGIS-012 | validator-qualityforge (QF) | QF | I | C | I |
| LOGIS-013 | domainforge-ai-logisticsdirector (DF) | DF | A | I | I |
| LOGIS-013a | validator-qualityforge (QF) | QF | C | C | I |
| LOGIS-014 | validator-qualityforge (QF) | QF/DF | R | C | C |
...
- **Level 3** (1hr): Cross-company escalation (domainforge-ai-logisticsdirector)
...
| Final sign-off | LOGIS-014 issue close | End of project |
