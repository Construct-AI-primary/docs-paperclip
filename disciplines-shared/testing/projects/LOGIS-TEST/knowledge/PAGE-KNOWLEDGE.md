---
title: 01700 Logistics Page — Component Knowledge
description: Complete page architecture, component inventory, and 8-field metadata for the 01700 logistics discipline page
author: QualityForge AI / KnowledgeForge AI
date: 2026-04-30
version: 1.0
memory_layer: working_knowledge
para_section: testing/projects/LOGIS-TEST/knowledge
---

# 01700 Logistics Page — Component Knowledge

## Page Overview

- **Page ID**: `01700-logistics`
- **Discipline Code**: `01700`
- **File Path**: `client/src/pages/01700-logistics/components/01700-logistics-page.js`
- **Background Image**: `getThemedImagePath("01700.png")` — logistics blue gradient
- **Chatbot**: `LogisticsChatbot` — logistics blue theme (#0D47A1/#1565C0), HITL confidence=0.7
- **Nav Container**: `A-01700-navigation-container` — fixed bottom center
- **Button Container**: `A-01700-button-container` — fixed viewport center, CSS Grid
...
[
  {
    ...
    "ui_buttons": {
      ...
      "action": "openModal('01700-FreightBookingModal')",
      "target": "01700-FreightBookingModal"
    },
    "supabase_schema": {
      "table": "logistics_freight",
    ...
    "qc_checklist": [
      ...
      "Modal opens: 01700-FreightBookingModal",
      "Shipment form fields match logistics_freight schema",
  ...
  },
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-CustomsClearanceModal')",
      "target": "01700-CustomsClearanceModal"
    },
    "supabase_schema": {
      "table": "logistics_customs",
    ...
    "qc_checklist": [
      "Button renders in Agents state",
      "Modal opens: 01700-CustomsClearanceModal",
      "Declaration form fields match logistics_customs schema",
...
[
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-UpsertCloudModal')",
      "target": "01700-UpsertCloudModal"
    },
    "supabase_schema": {
      "table": "vectors",
    ...
    "qc_checklist": [
      ...
      "Modal opens: 01700-UpsertCloudModal",
  ...
  },
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-UpsertUrlModal')",
      "target": "01700-UpsertUrlModal"
    },
    "supabase_schema": null,
    "qc_checklist": [
      "Button renders in Upserts state",
      "Modal opens: 01700-UpsertUrlModal",
  ...
  },
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-UpsertFileModal')",
      "target": "01700-UpsertFileModal"
    },
    "supabase_schema": null,
    "qc_checklist": [
      "Button renders in Upserts state",
      "Modal opens: 01700-UpsertFileModal",
...
[
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-FleetManagementModal')",
      "target": "01700-FleetManagementModal"
    },
    "supabase_schema": {
      "table": "logistics_fleet",
    ...
    "qc_checklist": [
      ...
      "01700-FleetManagementModal opens",
  ...
  },
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-WarehouseManagementModal')",
      "target": "01700-WarehouseManagementModal"
    },
    "supabase_schema": null,
    "qc_checklist": [
      "Button renders in Workspace state",
      "01700-WarehouseManagementModal opens",
  ...
  },
  {
    ...
    "ui_buttons": {
      ...
      "class": "modal-trigger-button",
      "action": "openModal('01700-SupplierDirectoryModal')",
      "target": "01700-SupplierDirectoryModal"
    },
    "supabase_schema": {
      "table": "suppliers",
    ...
    "qc_checklist": [
      "Button renders in Workspace state",
      "01700-SupplierDirectoryModal opens",
...
- [ ] Background image loads: `01700.png` (logistics blue gradient)
...
- [ ] Chatbot: logistics blue theme (#0D47A1/#1565C0), HITL confidence=0.7
- [ ] CSS classes: `logistics-page`, `page-background`, `A-01700-*` prefix
...
|-------|-------------|-------------|---------|
| `logistics_freight` | id | shipment_id, origin, destination, carrier, mode, weight_kg, status | LOGIS-003 |
| `logistics_customs` | id | declaration_id, shipment_id, clearance_status, duty_amount, documents | LOGIS-003 |
| `logistics_fleet` | id | vehicle_id, driver, route, status, last_gps_lat, last_gps_lng, fuel_level, maintenance_due | LOGIS-005, LOGIS-009 |
| `suppliers` | id | name, type, contact, status, rating | LOGIS-005 |
| `vectors` | id | embedding, metadata, discipline | LOGIS-004, LOGIS-011 |
