---
title: 02400 Safety — Complete Metadata Bundle
description: Single JSON bundle of all 8-field metadata for 02400 page components, ready for upload to QC-ROOT issue
author: KnowledgeForge AI
date: 2026-04-30
version: 1.0
---

# 02400 Safety — Complete Metadata Bundle
...
| Supabase tables referenced | 5 (safety_freight, safety_customs, safety_fleet, suppliers, vectors) |
| Extraction date | 2026-04-30 |
| Upload target | QC-ROOT-SAFETY-2026 issue Documents |
...
```json
{
  ...
  "template_pages": [
    ...
    },
    {
      ...
      "template_score": 0.88,
      "supabase_schema": {"table": "safety_freight", "columns": ["id","shipment_id","origin","destination","carrier","mode","weight_kg","status","created_at","updated_at"], "indexes": ["primary_key","shipment_id_idx"]},
      "qc_checklist": ["Button renders in Agents state", "Modal opens: 02400-FreightBookingModal", "Shipment form matches schema", "Booking persists", "Modal closes"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "template_score": 0.88,
      "supabase_schema": {"table": "safety_customs", "columns": ["id","declaration_id","shipment_id","clearance_status","duty_amount","documents","customs_officer","cleared_at"], "indexes": ["primary_key","declaration_id_idx"]},
      "qc_checklist": ["Button renders in Agents state", "Modal opens: 02400-CustomsClearanceModal", "Declaration form matches schema", "Clearance persists", "Doc upload works"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "qc_checklist": ["Button renders in Upserts state", "Modal opens: 02400-UpsertCloudModal", "Insert succeeds", "Error handling works"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "template_score": 0.85,
      "supabase_schema": {"table": "vectors", "columns": ["id","embedding","metadata","discipline"], "indexes": ["primary_key","hnsw"]},
      "qc_checklist": ["Button renders in Upserts state", "Modal opens: 02400-UpsertUrlModal", "URL fetch succeeds", "Data insert succeeds"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "template_score": 0.85,
      "supabase_schema": {"table": "vectors", "columns": ["id","embedding","metadata","discipline"], "indexes": ["primary_key","hnsw"]},
      "qc_checklist": ["Button renders in Upserts state", "Modal opens: 02400-UpsertFileModal", "File upload/parse succeeds", "Data insert succeeds"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "template_score": 0.88,
      "supabase_schema": {"table": "safety_fleet", "columns": ["id","vehicle_id","driver","route","status","last_gps_lat","last_gps_lng","fuel_level","maintenance_due","created_at"], "indexes": ["primary_key","vehicle_id_idx"]},
      "qc_checklist": ["Button renders in Workspace state", "02400-FleetManagementModal opens", "Fleet CRUD persists", "Vehicle status updates", "GPS coords render"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "template_score": 0.85,
      "supabase_schema": null,
      "qc_checklist": ["Button renders in Workspace state", "02400-WarehouseManagementModal opens", "Inventory displays", "Stock updates persist"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
      ...
      "qc_checklist": ["Button renders in Workspace state", "02400-SupplierDirectoryModal opens", "Supplier CRUD persists", "Card JSONs render"],
      "last_updated": "2026-04-30"
    },
    {
      "page_id": "02400-safety",
...
1. Upload this bundle to the **QC-ROOT-SAFETY-2026** issue's Documents tab
