-- ============================================================
-- FINAL AGENT NAME FIXES
-- Standalone SQL file for fixing remaining problematic agent names
...
-- Verification query:
-- SELECT company_id, title, name FROM agents WHERE name LIKE '%qualityforge%' OR name LIKE '%paperclip%' OR name = 'A-p' OR name LIKE '%domainforge%' OR name LIKE '%learningforge%' ORDER BY company_id, title;