-- ============================================================
-- REMOVE REMAINING BAD DUPLICATE AGENTS
-- Remove duplicate records that still have bad/incorrect names
-- Keep the records with proper names that we just fixed
-- Updated: 2026-04-27 (removed FK-constrained agent)
-- Total duplicates to remove: 11
-- ============================================================
