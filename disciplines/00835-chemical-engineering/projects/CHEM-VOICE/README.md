# CHEM-VOICE — Chemical Engineering Voice Call System
...
| Property | Value |
|----------|-------|
| Project Code | CHEM-VOICE |
| Discipline | 00835-chemical-engineering |
| Discipline Code | 00835 |
| Badge Label | Chemical |
...
3. **CHEM-VOICE** defines which discipline-specific `disciplineCode` to pass when calling the shared override
