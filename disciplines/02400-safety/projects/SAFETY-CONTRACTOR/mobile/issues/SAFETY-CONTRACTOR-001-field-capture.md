...
title: Implement Contractor Safety Management Mobile Field Data Capture
...
# SAFETY-CONTRACTOR-001: Implement Contractor Safety Management Mobile Field Data Capture

## Description

Implement the mobile field data capture interface for the Contractor Safety Management system. This enables field workers to collect, record, and submit contractor safety management data directly from construction sites using mobile devices.

**Context**: Field workers are the primary data source for contractor safety management operations. A mobile-first interface designed for construction site conditions (gloves, sunlight, dust) is essential for data quality and worker adoption.
...
- **Target Files**:
  - `docs-paperclip/disciplines/02400-safety/projects/SAFETY-CONTRACTOR/mobile/issues/`
  - `packages/shared/src/safety/safetycontractor/mobile-types.ts`
