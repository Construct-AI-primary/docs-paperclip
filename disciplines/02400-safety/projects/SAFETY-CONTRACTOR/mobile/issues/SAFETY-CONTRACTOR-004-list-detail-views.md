...
title: Implement Contractor Safety Management Mobile List and Detail Views
...
# SAFETY-CONTRACTOR-004: Implement Contractor Safety Management Mobile List and Detail Views

## Description

Implement the mobile list and detail views for the Contractor Safety Management system. These views are the primary navigation pattern for field workers accessing contractor safety management records on mobile devices.

**Context**: Field workers need to quickly scan lists of contractor safety management records and drill into details. The mobile list/detail pattern must be optimized for one-handed use, fast loading, and progressive disclosure of information.

**Objectives**:
- Create searchable, filterable list view for contractor safety management records
...
- [ ] List view displays contractor safety management records with key summary information
...
- **Target Files**:
  - `packages/shared/src/safety/safetycontractor/mobile-views.ts`
