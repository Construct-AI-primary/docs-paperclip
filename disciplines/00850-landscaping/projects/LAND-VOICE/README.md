# LAND-VOICE — Landscaping Voice Call System
...
| Property | Value |
|----------|-------|
| Project Code | LAND-VOICE |
| Discipline | 00850-landscaping |
| Discipline Code | 00850-L |
| Badge Label | Landscaping |
...
3. **LAND-VOICE** defines which discipline-specific `disciplineCode` to pass when calling the shared override
