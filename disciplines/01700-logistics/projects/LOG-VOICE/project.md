---
title: "LOG-VOICE Project Charter — Logistics Voice Call System"
description: "Project charter for the LOG-VOICE Logistics Voice Call System"
...
# LOG-VOICE Project Charter

## Project Overview

**Project Name**: Logistics Voice Call System
**Project Code**: LOG-VOICE
**Discipline**: 01700-logistics
...
### In Scope
- Discipline-specific phone number sources (Carrier/transport provider)
- Discipline-specific document sources for call context
- Integration with 01700 Dispatch & Coordination Workflow
- dispatcher+ role gate enforcement
