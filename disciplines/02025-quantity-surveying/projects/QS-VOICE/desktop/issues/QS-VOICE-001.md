---
title: "QS-VOICE-001 — Core voice call interface for quantity surveying"
description: "Implement the VoiceCall modal for QS, including number selection from contractor_contacts.phone and subcontractor_contacts.phone"
project: QS-VOICE
...
# QS-VOICE-001 — Core voice call interface for quantity surveying

## Description

Implement the VoiceCall modal for QS, including number selection from contractor_contacts.phone and subcontractor_contacts.phone
