# GEO-VOICE — Geotechnical Engineering Voice Call System
...
| Property | Value |
|----------|-------|
| Project Code | GEO-VOICE |
| Discipline | 00855-geotechnical-engineering |
| Discipline Code | 00855 |
| Badge Label | Geotechnical |
...
3. **GEO-VOICE** defines which discipline-specific `disciplineCode` to pass when calling the shared override
