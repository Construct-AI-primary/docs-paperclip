# MECH-VOICE — Mechanical Engineering Voice Call System
...
| Property | Value |
|----------|-------|
| Project Code | MECH-VOICE |
| Discipline | 00870-mechanical-engineering |
| Discipline Code | 00870 |
...
3. **MECH-VOICE** defines which discipline-specific `disciplineCode` to pass when calling the shared override
